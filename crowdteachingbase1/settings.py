...
ROOT_URLCONF = 'crowdteachingbase1.urls'
...
SECRET_KEY = os.environ['SECRET_KEY_CROWD_TEACHING_TEST']
...
# SITE_ID for django.contrib.sites, deprecated for enlingo.com as using two wsgi5.py modules to represent two subdomains: enlingo.com - student_settings
